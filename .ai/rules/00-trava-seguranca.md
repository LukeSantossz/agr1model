...
1. **Task registrada:** Existe uma task formalmente descrita no arquivo `tasks.md` (localizado na pasta `.ai/`, junto a este arquivo). Se `tasks.md` não existir ou estiver vazio, o agente deve solicitar ao usuário que crie e preencha a task antes de qualquer ação.
